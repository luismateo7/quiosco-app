    ...
    return (
        <div className="border p-10 space-y-5">
            ...
            <div className="md:flex md:items-center md:justify-between my-10">
                ...
                <button
                    className="bg-indigo-600 hover:bg-indigo-800 mt-5 md:mt-0 py-3 px-10 uppercase font-bold rounded-lg text-white"
                    type="button"
                    onClick={completarOrden}
                >Orden Completa</button>
            </div>
        </div>
    )
}
